...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    DetailType2ViewController* vc = [self.storyboard instantiateViewControllerWithIdentifier:@"DetailType2ViewController"];
...
- (void)locUpdate {
    ...
    if (currentLocation != nil) {
        ...
        NSString *url = @"https://ohmyjeju.herokuapp.com/places/foods";
